...
if length(unsepClusterMark) == NumOfClusters && NumOfClusters == 1
    ...
    subplot('Position',[0.933 0.111 0.025 0.813]);
    imagesc(1,0:Step:64,(1:64)');
    set(gca,'xTickLabel','');
    set(gca, 'yTick',color_code);
    yticklabel = num2cell(1:max(annoPlot));
    set(gca,'yTickLabel',cellfun(@num2str, yticklabel(:)), 'fontsize', 14);
